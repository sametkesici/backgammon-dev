...
public class JwtUtils {
  ...
  @Value("${backgammon.app.jwtSecret}")
  private String jwtSecret;

  @Value("${backgammon.app.jwtExpirationMs}")
  private int jwtExpirationMs;

  @Value("${backgammon.app.jwtCookieName}")
  ...
  public ResponseCookie generateJwtCookie(BackGammonUserDetails userPrincipal) {
